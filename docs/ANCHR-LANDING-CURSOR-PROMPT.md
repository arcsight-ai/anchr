...
**Layout:**
- Sticky top nav: ANCHR left; Docs / GitHub / Install right; CTA "Install GitHub Action"
- Hero: headline, subhead, 2 CTAs (Install GitHub Action, Run locally), and a **PR-comment style card** visual
